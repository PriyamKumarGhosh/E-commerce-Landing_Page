    ...
    <section id="about-us" className="flex justify-between items-center max-lg:flex-col gap-10 w-full max-container">
      ...
      <div className='flex flex-1 flex-col'>
        ...
        <h2 className="font-palanquin text-4xl capitalize font-bold lg:max-w-lg">
          ...
          <p className="mt-4 lg:max w-lg info-text">Ensuring premium comfort and style, our meticulously crafted footware is designed to elevate your experience, providing you unmatched quality, innovation, and a touch of elegance.</p>
